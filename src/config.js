...
const config = {
    ...
    commonService: "http://srd.iptime.org:8007/web/srd/common",
    mainSummryService: "http://srd.iptime.org:8004/web/rec/api/mpa/analysis/summry/count",
