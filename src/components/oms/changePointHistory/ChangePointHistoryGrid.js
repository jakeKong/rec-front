      ...
      return (
        <Fragment>
            ...
            <vaadin-grid theme="column-borders row-stripes" height-by-rows column-reordering-allowed>
                <vaadin-grid-column path="changeDt" header="변동 일자" text-align="center" flex-grow="2"></vaadin-grid-column>
                <vaadin-grid-column path="changeType" header="변동 유형" text-align="center" flex-grow="1"></vaadin-grid-column>
                <vaadin-grid-column path="changePoint" header="변동 포인트" text-align="center" flex-grow="1.5"></vaadin-grid-column>
                <vaadin-grid-column path="currentBalPoint" header="남은 포인트" text-align="center" flex-grow="1.5"></vaadin-grid-column>
                <vaadin-grid-column path="odrNo" header="주문번호" text-align="center" flex-grow="2"></vaadin-grid-column>
                <vaadin-grid-column path="purchaseNo" header="구매번호" text-align="center" flex-grow="2"></vaadin-grid-column>
            </vaadin-grid>
        </Fragment>
      );
  }
