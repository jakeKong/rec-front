...
class QuestionContainer extends Component {
  ...
  //     console.log(nextProps.questionAnswerList);
  //   }
  //   // if (nextProps.questionAnswerList !== prevState.answerList) {
  //   //   console.log(nextProps.questionAnswerList);
  //   //   return { answerList: nextProps.questionAnswerList }
  //   // }
  //   return null;
  // }
  ...
  //     return true;
  //   }
  //   if (nextProps.questionList !== undefined && nextProps.questionList !== null) {
  //     return true;
  //   }
  //   else return false;
    ...
    // if (nextProps.questionAnswerCmtList !== undefined && nextProps.questionAnswerCmtList !== null) {
      // this.setState({cmtList: nextProps.questionAnswerCmtList});
      // nextProps.questionAnswerCmtList.forEach(e => {
      //   this.getCmtList.push({
      ...
      //   });
      // });
      // this.setState({cmtList: this.getCmtList});
      // this.detailStatusChangeEvent();
    // }
    // // if (questionAnswerCmtList !== undefined && questionAnswerCmtList !== null) {
    //   // let getCmtList = [];
    //   // this.setState({cmtList: this.state.cmtList.push(nextProps.questionAnswerCmtList)});
    //   // this.getCmtList.push(nextProps.questionAnswerCmtList);
    //   nextProps.questionAnswerCmtList.forEach(e => {
    //     // this.getCmtList.push(fromJS(e));
    //     // console.log(e);
    //     // this.setState({cmtList: this.cmtList.push(Map({e}))})
    //     // this.getCmtList.push(Map({e}));
    //     this.getCmtList.push({
    //       questionAnswerCmtSid: e.get('questionAnswerCmtSid'),
    //       questionAnswerSid: e.get('questionAnswerCmtSid'),
    //       cmtTxt: e.get('questionAnswerCmtSid'),
    ...
    //     })
    //   });
      // this.getCmtList.push(Map({test: 1}));
      // this.setState({cmtList: this.getCmtList});
      // const {cmtList} = this.state;
      // console.log(cmtList);
      // console.log(this.nextProps.questionAnswerCmtList);
      ...
      <Fragment>
        <div>
          ...
          <div className="div-main">
            ...
            { detailStatus && questionAnswerList && <QuestionDetail question={ question } questionAnswerList={ questionAnswerList } detailToListCallback={ this.detailToListCallback } registerCallback={ this.registerCallback } deleteCallback={ this.deleteCallback } addAnswerCallback={ this.addAnswerCallback } /> }
