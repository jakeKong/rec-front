...
export const addQuestion = createAction(ADD_QUESTION, (email, dto) => ({email, dto}));
export const addQuestionAnswer = createAction(ADD_QUESTION_ANSWER, (questionSid, email, dto) => ({questionSid, email, dto}));
export const addQuestionAnswerCmt = createAction(ADD_QUESTION_ANSWER_CMT, (questionAnswerSid, email, dto) => ({questionAnswerSid, email, dto}));

export const updateQuestion = createAction(UPDATE_QUESTION, (questionSid, email, dto) => ({questionSid, email, dto}));
...
export const updateQuestionAnswerCmt = createAction(UPDATE_QUESTION_ANSWER_CMT, (questionAnswerSid, questionAnswerCmtSid, email, dto) => ({questionAnswerSid, questionAnswerCmtSid, email, dto}));

export const deleteQuestionByEmail = createAction(DELETE_QUESTION_BY_EMAIL, (questionSid, email) => ({questionSid, email}));
...
export const deleteQuestionAnswerCmtByEmail = createAction(DELETE_QUESTION_ANSWER_CMT_BY_EMAIL, (questionAnswerSid, questionAnswerCmtSid, email) => ({questionAnswerSid, questionAnswerCmtSid, email}));
...
function* getQuestionListSaga() {
  try {
    const response = yield call(api.getQuestionList);
...
function* deleteQuestionByListSaga(action) {
  try {
    const response = yield call(api.deleteQuestionByList, action.payload);
...
function* addQuestionSaga(action) {
  try {
    ...
    // 추가완료 이후 목록 갱신 호출
    yield call(getQuestionListByEmailSaga, action.payload.email);
  } catch (error) {
...
function* addQuestionAnswerSaga(action) {
  try {
    ...
    // 추가완료 이후 답변 목록 갱신 호출
    yield call(getQuestionAnswerListSaga, action.payload.questionSid);
  } catch (error) {
...
function* addQuestionAnswerCmtSaga(action) {
  try {
    ...
    yield call(getQuestionAnswerCmtListSaga, action.payload.questionAnswerSid);
  } catch (error) {
