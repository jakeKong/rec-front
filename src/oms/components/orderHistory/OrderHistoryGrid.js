    ...
    return (
      <div>
        ...
        <vaadin-grid theme="column-borders row-stripes" height-by-rows column-reordering-allowed>
          ...
          <vaadin-grid-column path="odrDt" header="주문 일자" text-align="center" flex-grow="10" />
          ...
          <vaadin-grid-column path="variationPoint" header="증감 포인트" text-align="end" flex-grow="10" />
          <vaadin-grid-column path="downloadEndDt" header="다운로드 만료기간" text-align="center" flex-grow="10" />
          <vaadin-grid-column id="grdBtnDownload" header="다운로드" text-align="center" flex-grow="8" />
          <vaadin-grid-column path="downloadCnt" header="다운로드 횟수" text-align="center" flex-grow="1" />
          <vaadin-grid-column path="status" header="상태" text-align="center" flex-grow="10" />
