...
// 조건별 상품 조회
export const getProductList = (search) => axios({
  method: 'POST',
...
// 상품 추가
export const addProduct = (dto) => axios({
  method: 'POST',
...
// 상품 수정
export const updateProduct = (dto) => axios({
  method: 'PUT',
...
// 상품 삭제
export const deleteProduct = (productSid) => axios({
  method: 'DELETE',
